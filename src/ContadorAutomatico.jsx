...
import { activarEventoOnClickEnComponenteA } from './EventoClickIndirecto';
...
const dosFuncionesClick=()=>{
    ...
    return (
        <div>
            ...
            <button onClick={dosFuncionesClick}>Iniciar</button>
    ...
    // function activarEventoOnClickContadorAutomatico() {
    // ContadorAutomatico.dosFuncionesClick();
    // }
}
// export const funcionExportada=()=>{
//     activarEventoOnClickEnContadorAutomatico()
// } 
